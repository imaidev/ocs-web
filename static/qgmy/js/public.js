...
$(function(){
	...
	$(window).scroll(function(){
		...
		var scrollHF=navTop+navH;
		if( $(window).scrollTop()>scrollHF ){
			if( $("#store") ){
				$("#store").addClass('fixedModel');
			}
			if( $("#search") ){
				$("#search").addClass('fixedModel');
			}
		}else{
			if( $("#store") ){
				$("#store").removeClass('fixedModel');
			}
			if( $("#search") ){
				$("#search").removeClass('fixedModel');
			}
		}
	})
})	
