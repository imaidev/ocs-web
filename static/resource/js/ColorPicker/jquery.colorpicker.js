...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        function initColor(){
            ...
            +'<tr><td width="3"><td><input type="text" id="DisColor" size="6" disabled style="width:64px;line-height:19px;height:19px;border:solid 1px #000000;background-color:#ffff00"></td>'
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="width:64px;line-height:19px;height:19px;border:inset 1px;font-family:Arial;" value="#000000"><a href="javascript:void(0);" id="_cclose">关闭</a> | <a href="javascript:void(0);" id="_creset">重置</a></td></tr></table></td></table>'
