	...
	// Flash Satay object syntax: http://www.alistapart.com/articles/flashsatay
	 ...
	 if(navigator.userAgent.indexOf("MSIE")>0){
		...
		return ['<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" id="', this.movieName, 
		           '" type="application/x-shockwave-flash" data="', this.settings.flash_url, '" width="', this.settings.button_width, 
		           ...
		           '<param name="allowScriptAccess" value="always" />',
		           '<param name="flashvars" value="' , this.getFlashVars() , '" />',
		           '<embed src="',this.settings.flash_url,'" id="',this.movieName, '" type="application/x-shockwave-flash" width="', this.settings.button_width, '" height="', this.settings.button_height,
		           '" quality="high" allowScriptAccess="always" menu="false" wmode="transparent" flashvars="',this.getFlashVars(),'"></embed></object>'].join(""); 
...
SWFUpload.prototype.getMovieElement = function () {
	if (this.movieElement == undefined) {
		if(navigator.userAgent.indexOf("Firefox")>0){
			this.movieElement = document.embeds[this.movieName];
		}else{
