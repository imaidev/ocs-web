(function ($) {
    ...
    $.fn.sitenotice = function (oper, opts) {
        if (!oper) oper = "init";
    ...
    var render = function ($widget, dataval) {
        var opts = $.extend({}, $.fn.sitenotice.defaults, dataval);
        if(opts.type && opts.subtype){
        	var vurl =ctx+opts.vistorurl + '&vend_id=' + g_vendid + '&NOTICE_SCOPE=' + opts.type + '&market_id='+opts.subtype;
