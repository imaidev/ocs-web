...
/***************收藏本站方法begin*******************/
function AddSiteFavorite(title, url) {
	if (url == null || url == "") {
	 ...
	 */
	  $.fn.countDown = function(options){
		...
		//补零
			...
			range = endT - beginT;
			$targetObj.append("<ul><li class='days'></li><li class='split'>days</li><li class='hours'></li><li class='split'>:</li><li class='mins'></li><li class='split'>:</li><li class='sec'></li></ul>");
			//初始化
